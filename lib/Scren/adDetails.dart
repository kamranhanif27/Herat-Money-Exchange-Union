...
class AdDetails  extends StatefulWidget {
  ...
  final String img;
  final int index;
  AdDetails({this.viewers, this.date, this.title, this.detail, this.id, this.img, this.video, this.index});
...
class _AdDetailsState extends State<AdDetails> {
  ...
  Future<List<dynamic>> _addViewer() async {
    ...
    Response response =
    await post('http://heratexchangeunion.com/wp-json/advertise/v1/post/${widget.id}');
